...
export default function Hero({ hero }: HeroProps) {
  return (
    <section className="relative min-h-screen flex items-center justify-center text-white">
      ...
      <div className="relative container mx-auto px-6 md:px-12 flex flex-col lg:flex-row items-center  justify-center lg:justify-between h-full lg:space-y-10">
        {/* Text Content (Left Side) */}
        <div className="lg:w-3/4 w-full text-left bg-black bg-opacity-30 p-4 mt-8 lg:mt-0 rounded-lg shadow-lg backdrop-blur-sm order-2 lg:order-1">
