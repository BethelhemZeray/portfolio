...
export const section: TSections = {
  about: {
    ...
    h2: "Who I Am",
    content:
      "I'm Bethelhem Zeray, a Full-Stack Developer with a passion for building high-performance web apps and real-time systems using Next.js, Node.js, and Docker.",
  },
  skills: {
    p: "Skills",
    h2: "Tech Stack",
